...
describe('tests for getHarmonies function', () => {
  ...
  it('should return color of hue 180 for 1 harmony and a base color with h:0', () => {
  ...
  it('should return color with hue 179 for 1 harmony and base color with h:359', () => {
...
describe('tests for getHarmonies function', () => {
  it('should return an empty array for opposite of 0', () => {
